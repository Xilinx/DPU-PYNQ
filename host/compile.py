...
parser = argparse.ArgumentParser(description="""DPU-PYNQ helper script for downloading and compiling models from the Vitis AI modelzoo. 
        For list of models see: https://github.com/Xilinx/Vitis-AI/tree/v3.0/model_zoo/model-list""")
...
def download_model(model_name):
    ...
    yaml_url = f"https://github.com/Xilinx/Vitis-AI/raw/v3.0/model_zoo/model-list/{model_name}/model.yaml"
    download_url = None
...
def compile_model(model_dir, arch="/opt/vitis_ai/compiler/arch/DPUCZDX8G/ZCU104/arch.json", output_dir='.'):
    ...
    model_dir -- local folder name of the extracted model, e.g. "tf_inceptionv1_imagenet_224_224_3G_3.0"
